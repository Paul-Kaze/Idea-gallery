...
* 元数据表：图片（id、model、prompt、ref\_ids、uploaded\_at、user\_id）、参考图（id、path、url、target\_id）、用户（id、name、avatar、expires\_at）
...
* 列表接口：数据库索引（图片 id、user\_id、uploaded\_at）；分页查询 + 轻量响应体
