...
const ResponsiveMasonry = dynamic<any>(() => import('react-responsive-masonry').then(m => m.ResponsiveMasonry), { ssr: false })
const Masonry = dynamic<any>(() => import('react-responsive-masonry').then(m => m.default), { ssr: false })
